    ...
    <>
      ...
      {loading && (
        <div style={{
          ...
          <div style={{
            width: 14, height: 14, border: `2px solid ${B.raptorYellow}`,
      ...
      {!loading && data.length > 0 && (
        <>
          ...
          <div style={{
            ...
            <div style={{
              fontSize: 11, color: B.textSecond, fontWeight: 600, marginBottom: 12,
                    ...
                    <tr key={row.countryCode} style={{ borderBottom: `1px solid ${B.border}` }}
                      ...
                      <td style={{ padding: "10px 14px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          <div style={{
                            width: Math.max(3, (row.sessions / maxSessions) * 48), height: 4,
...
function OrganicFacebookSection() {
  ...
  if (loading) return (
    <div style={{
      ...
      <div style={{
        width: 14, height: 14, border: `2px solid ${accent}`,
        borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.8s linear infinite"
      }} />
  ...
  return (
    <>
      <div style={{ display: "flex", gap: bp.isMobile ? 6 : 10, flexWrap: "wrap", marginBottom: 4 }}>
        {metricKeys.map(k => (
          <div key={k} style={{
            background: B.surface, borderRadius: 6, padding: "10px 14px",
            border: `1px solid ${B.border}`, flex: "1 1 110px", borderTop: `3px solid ${accent}`
          }}>
            <div style={{
              fontSize: 9, fontFamily: "'Barlow Condensed',sans-serif", color: B.textMuted,
          ...
          <tbody>
            {byPlatform.map(row => (
              <tr key={row.platform} style={{ borderBottom: `1px solid ${B.border}` }}
                ...
                onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                <td style={{
                  padding: "10px 14px", fontWeight: 600, color: B.textPrimary,
        ...
        <tbody>
          {rows.map((row, i) => (
            <tr key={i} style={{ borderBottom: `1px solid ${B.border}`, cursor: onRowClick ? "pointer" : "default" }}
              ...
              <td style={{
                padding: "9px 14px", fontFamily: "'Barlow Condensed',sans-serif", fontWeight: 600, fontSize: 11,
              ...
              return (
                <div key={camp.name} style={{ borderBottom: ci < campaignAgg.length - 1 ? `1px solid ${B.border}` : "none" }}>
                  ...
                  <div onClick={() => setSelectedCampaign(campOpen ? null : camp.name)}
                    ...
                    <span style={{
                      fontSize: 12, color: accent, marginRight: 10, transition: "transform 0.2s",
                      display: "inline-block", transform: campOpen ? "rotate(90deg)" : "rotate(0deg)"
                    }}>›</span>
                    <span style={{
                    ...
                    {DRILL_METRICS.filter(k => ["impressions", "spend", "leads"].includes(k)).map(k => (
                      <span key={k} style={{
                        marginLeft: 20, fontFamily: "'Barlow Condensed',sans-serif",
                        ...
                        return (
                          <div key={adset.name} style={{ borderBottom: ai < adsetAgg.length - 1 ? `1px solid ${B.border}` : "none" }}>
                            ...
                            <div onClick={() => setSelectedAdset(adsetOpen ? null : adset.name)}
                              style={{
                                display: "flex", alignItems: "center", padding: "10px 14px 10px 32px",
                              ...
                              <span style={{
                                fontSize: 11, color: B.textMuted, marginRight: 10, transition: "transform 0.2s",
                                display: "inline-block", transform: adsetOpen ? "rotate(90deg)" : "rotate(0deg)"
                              }}>›</span>
                              <span style={{
                                flex: 1, fontFamily: "'Barlow Condensed',sans-serif", fontWeight: 600,
